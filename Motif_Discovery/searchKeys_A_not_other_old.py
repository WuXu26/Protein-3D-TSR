	...
	for group in groups:
		...
		for group2 in groups:
			if group != group2:
				...
				# 		args.setting, 'intersect_keys_{}_{}.csv'.format(group, group2)))
			else:
				t.append(len(groups_cKeys[group]))
		t_all[group] = t
