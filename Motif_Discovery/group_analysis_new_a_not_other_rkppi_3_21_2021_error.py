...
def generate_all_others_together_df(all_others_together, all_files_in_others, group_percent_threshold):
    ...
    df_all_others_together = df_all_others_together.sort_values(['percent_ratio1', 'group_percent'], ascending = False)
    print('All Others Together DF')                                                            
...
def generate_box_plot(all_others_together, all_files_in_others, group_in_test):
    ...
    ax.set_xlabel("Percentage of Keys in only {} group(%)".\
